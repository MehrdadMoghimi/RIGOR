...
def pretty_print_args(args: Any, title: str = "Training Configuration") -> None:
    ...
    Example:
        >>> from qrdqn_mean_cvar import Args
    ...
    categories = {
        "Experiment": ["exp_name", "seed", "dir", "track", "wandb_project_name", "wandb_entity", "capture_video", "save_model"],
        "Environment": ["env_id", "num_envs"],
        "Algorithm": ["total_timesteps", "learning_starts", "learning_rate", "train_frequency"],
        "Network": ["n_quantiles", "batch_size", "buffer_size"],
        "Optimization": ["gamma", "tau", "target_network_frequency", "huber_k"],
        "Exploration": ["start_e", "end_e", "exploration_fraction"],
        "Discounting": ["discount_factor", "hyperbolic_k", "time_aware"],
        "Risk-Sensitive": ["risk_level", "mean_weight", "target_averaging"],
        "Stock (Mean-CVaR)": ["initial_stock", "reward_normalizer", "stock_min", "stock_max", "stock_frequency", "stock_grid_size"],
        "Data Augmentation": ["stock_editing", "stock_editing_fanout"],
        "PyTorch": ["cuda", "torch_deterministic"],
    }
